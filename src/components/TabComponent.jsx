...
const TabComponent = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-4">
            ...
            {/* Tab content */}
            <div className="pt-6 space-y-4 flex justify-center">
                {activeTab === 1 && (
                    <div className="tab-pane">
                        <h2 className="text-3xl font-semibold text-center mb-11">End-to-End functional safety support tailored for OEMs, Tier-1s, and startups.</h2>
                        <Carousel />
                    </div>
                )}
                ...
                {activeTab === 2 && (
                    <div className="tab-pane">
                        <h2 className="text-3xl font-semibold text-center mb-11">Providing expert software development using Microsoft technologies for over 13 years of experience.</h2>
                        <CloudCarousel />
                    </div>
                )}
            </div>
